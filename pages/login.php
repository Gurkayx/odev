...
<body>
    ...
    <div class="welcomepagecontent px-6 md:px-36 mt-28 flex flex-col gap-4 mb-10">
        <div class="loginform flex items-center justify-center max-w-full">
            <form action="" id="loginform" class="max-w-md">
                ...
                <div class="flex flex-col items-center justify-center mb-2">
                    <p id="loginerrordiv" class="italic font-bold text-red-400 dark:text-gray-300 text-sm">
                    </p>
                </div>
                <div class="flex flex-col items-center justify-center mb-2">
                    <p class="italic font-bold text-red-400 dark:text-gray-300 text-sm">
                        </p>
                </div>
                ...
                <div class="mt-4">
                    ...
                    <div class="flex items-center justify-between">
                        <a href="./sign.php" class="mt-4 text-xs text-red-500 italic">Hesabınız yok mu?</a>
                    </div>
                </div>
            </form>
        </div>
