    ...
    <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8">
        <div class="mx-auto max-w-md">
            <strong class="block text-center text-xl font-bold text-gray-900 sm:text-3xl">
                E-posta bültenimize kayıt olmak istet misiniz?
            </strong>
            ...
            <form class="mt-6">
                <div class="relative max-w-lg">
                    ...
                    <input class="w-full rounded-full border-gray-200 bg-gray-100 p-4 pe-32 text-sm font-medium"
                        id="newsemailinput" type="email" placeholder="quick@link.com" />
        ...
        <div class="mt-16 grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-32">
            <div class="mx-auto max-w-sm lg:max-w-none">
                <p class="mt-4 text-center text-gray-500 lg:text-left lg:text-lg">
                    Yepyeni hızlı, reklamsız, ve ücretsiz bir link kısaltma servisi olmaktan mutluluk duyuyoruz.
                </p>
            ...
            <div class="grid grid-cols-1 gap-8 text-center lg:grid-cols-3 lg:text-left">
                <div>
                    <strong class="font-medium text-gray-900"> Sayfalar </strong>

                    <ul class="mt-6 space-y-1">
                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Kayıt </a>
                        </li>
                ...
                <div>
                    <strong class="font-medium text-gray-900"> yasal </strong>

                    <ul class="mt-6 space-y-1">
                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Gizlilik </a>
                        </li>

                        <li>
                            <a class="text-gray-700 transition hover:text-gray-700/75" href="#"> Kullanım </a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="mt-16 border-t border-gray-100 pt-8">
            <p class="text-center text-xs/relaxed text-gray-500">
                ...
                Created by
                <a href="#" class="text-gray-700 underline transition hover:text-gray-700/75">Gürkay</a>
                and with
                <span class="text-gray-700 transition hover:text-gray-700/75">Love ❤️</span>.
            </p>
        </div>
    </div>
</footer>